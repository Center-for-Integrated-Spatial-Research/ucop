...
function populateDistrictTable(a) {
	...
	dojo.forEach(fields, function(field,i) {
		...
		if (value != null) {
			...
			if (field == "Freshmen") {
				content += "<tr><td colspan=2></td><td></td></tr>";
				content +="<tr><td style=\"width:15px;\"></td><td>Freshman</td><td class=\"resultsTableAmounts\">" + value  + "</td></tr>"
			}
			if (field == "Student_Count") {
				content += "<tr><td colspan=2></td><td></td></tr>";
				content +="<tr><td colspan=2 class=\"resultsTableHeaderText\">Undergraduates Enrolled (2013)</td><td class=\"resultsTableAmounts\">" + value  + "</td></tr>"
			}
