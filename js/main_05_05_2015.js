...
var campusLargeUrl = "http://arcgis.cisr.ucsc.edu/arcgis/rest/services/UCOP/UCOP_20150507/MapServer/0";
var campusSmallFeatureLayer;
var medCenterSmallFeatureLayer;
var labSmallFeatureLayer;
var campusSmallUrl = "http://arcgis.cisr.ucsc.edu/arcgis/rest/services/UCOP/UCOP_20150507/MapServer/1";
var campusNames;
var reservesFeatureLayer;
var reservesUrl = "http://arcgis.cisr.ucsc.edu/arcgis/rest/services/UCOP/UCOP_20150507/MapServer/2";
...
var communityProgramUrl577k = "http://arcgis.cisr.ucsc.edu/arcgis/rest/services/UCOP/UCOP_20150507/MapServer/3";
var communityProgramFeatureLayer288k;
var communityProgramUrl288k = "http://arcgis.cisr.ucsc.edu/arcgis/rest/services/UCOP/UCOP_20150507/MapServer/4";
var communityProgramFeatureLayer144k;
var communityProgramUrl144k = "http://arcgis.cisr.ucsc.edu/arcgis/rest/services/UCOP/UCOP_20150507/MapServer/5";
var communityProgramFeatureLayer72k;
var communityProgramUrl72k = "http://arcgis.cisr.ucsc.edu/arcgis/rest/services/UCOP/UCOP_20150507/MapServer/6";

var assemblyFeatureLayer;
var assemblyUrl = "http://arcgis.cisr.ucsc.edu/arcgis/rest/services/UCOP/UCOP_20150507/MapServer/7"
var assemblyDistricts;
var senateFeatureLayer;
var senateUrl = "http://arcgis.cisr.ucsc.edu/arcgis/rest/services/UCOP/UCOP_20150507/MapServer/8"
var senateDistricts;
var congressFeatureLayer;
var congressUrl = "http://arcgis.cisr.ucsc.edu/arcgis/rest/services/UCOP/UCOP_20150507/MapServer/9"
...
function init(){
	...
	*/
	...
	medCenterSmallFeatureLayer.setScaleRange(0, 577700);
	...
	labSmallFeatureLayer.setScaleRange(0, 577700);
	...
	campusSmallFeatureLayer.setScaleRange(0, 577700);
	...
	medCenterLargeFeatureLayer.setScaleRange(577700, 0);
	...
	labLargeFeatureLayer.setScaleRange(577700, 0);
	...
	campusLargeFeatureLayer.setScaleRange(577700, 0);
...
function queryMultipleLayers(layer, fields, values, geometry) {
	...
	deferredList.then(function(results) {
		...
		var campusGeometry = processCampusResults(results[1][1])
		...
		} else if ((dijit.byId('layer').get('value') == "campus") && campusGeometry != '') {
			map.centerAndZoom(campusGeometry, 11)
		}
		dijit.byId("searchButton").set('disabled', false);
		dijit.byId("clearButton").set('disabled', false);
	});
...
function queryReserves(field, value) {
	...
	reservesLayerDefinition = sql;
	query.where = reservesLayerDefinition;
...
function resetMapLayersData(){
	...
	if ((map.getLevel() != maxLevel) && (addressInfo.address == "")) {
...
function checkLegendVisibility() {
	...
	dojo.forEach(dojo.query('[layerVisible]'), function (layer, i) {
		if (i <= 3) {
			if (dojo.getAttr(layer, 'layerVisible') == "true") { campusLayerVisibility.push(layer.id); campusLayerVisibility.sort() }		
		} else if (i > 3) {
...
function redrawLayers() {
	...
	} else if (level == 9 || level == 10) { //577k
		communityProgramFeatureLayer577k.setDefinitionExpression(communityProgramLayerDefinition);
		communityProgramFeatureLayer577k.show();
	} else if (level == 11) { //288k
		communityProgramFeatureLayer288k.setDefinitionExpression(communityProgramLayerDefinition);
	...
	medCenterLargeFeatureLayer.setDefinitionExpression(medCenterLayerDefinition);
	labLargeFeatureLayer.setDefinitionExpression(labLayerDefinition);
	reservesFeatureLayer.setDefinitionExpression(reservesLayerDefinition);
	
	dojo.forEach(campusLayerVisibility, function (layer) {
		if (dojo.indexOf(campusLayerVisibility, "University") >= 0) {
		...
		if (dojo.indexOf(campusLayerVisibility, "Medical Center") >= 0) {
		...
		if (dojo.indexOf(campusLayerVisibility, "Lab") >= 0) {
		...
		if (dojo.indexOf(campusLayerVisibility, "Reserves") >= 0) {
